        ...
        <Flex id="mc_embed_signup_scroll" fillWidth maxWidth={24} mobileDirection="column" gap="8">
          ...
          <div className="clear">
            <Flex height="48" vertical="center">
              <a
  href="https://wa.me/83991779519" // substitua pelo número com DDD, sem traços ou espaços
  target="_blank"
  rel="noopener noreferrer"
  style={{ display: "flex",
    justifyContent: "flex-end", // posiciona o botão mais à direita
    width: "100%",}}
>
  <Button size="l" // tamanho maior
    style={{
      maxWidth: "280px", // largura máxima do botão
    }}>
